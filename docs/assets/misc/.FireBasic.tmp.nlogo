...
Der Ablauf einer Simulation erfolgt also quasi von **oben** nach **unten**. -Mit Experiment wiederherstellen kann das Ausgansszenario (mit Ausnahme der initialen Feuerpositionen) wiederhergestellt werden.
